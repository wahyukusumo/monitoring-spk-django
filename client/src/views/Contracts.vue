<template>
  ...
  <!-- Add modal -->
  <FormModal :modal-show="addModalShow" :modal-title="'Add New Contract'" @closeApp="this.addModalShow = !this.addModalShow">
  ...
  <!-- Edit modal -->
  <FormModal :modal-show="editModalShow" :modal-title="'Edit Contract'" @closeApp="this.editModalShow = !this.editModalShow">
    <template v-slot:body>
    ...
    async updateContract(contract) {
      ...
      try {
        ...
        const response = await axios.put(`http://127.0.0.1:8000/api/pengadaan/${contract.id}/`, {
          nomor_spk: this.editContract.nomor_spk,
          vendor: this.editContract.vendor,
          tanggal_mulai: this.editContract.tanggal_mulai,
          tanggal_akhir: this.editContract.tanggal_akhir,
          uraian: this.editContract.uraian,
          nilai: this.editContract.nilai,
          basket: this.editContract.basket,
        });
        console.log(response.data.nomor_spk)
